            ...
            <div className="pl-8 py-2">
              ...
              <div className="flex mb-4">
                <span className="flex items-center">
                  ...
                  <span className="text-gray-600 ml-3">1.2M+ Reviews</span>
                </span>
              ...
              <div className="flex mt-4">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="flex text-white bg-red-500 rounded-l-none border-0 py-2 px-3 focus:outline-none hover:bg-purple-600 rounded"
                  >
                    Add To Cart
                  </button>
                </form>
